...
The current version is `0.1.19`, which can be added to your project with one or more of the following line(s)
...
```scala
// opencsv engine.
libraryDependencies += "com.nrinaudo" %% "kantan.csv-opencsv" % "0.1.19"
