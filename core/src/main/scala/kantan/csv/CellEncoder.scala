...
/** Encodes values of type `A` into CSV cells.
  ...
  * }}}
  *
  * Once this is done, kantan.csv will be capable of serialising date fields without any further work. The following,
  * for example, will create a [[RowEncoder]] for triples of type `(Int, String, Date)`:
  * {{{
