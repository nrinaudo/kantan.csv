...
class SerialisationTests extends DisciplineSuite {
  ...
  implicit val arbList: Arbitrary[List[Int]] = Arbitrary(Gen.nonEmptyListOf(Arbitrary.arbitrary[Int]))
  ...
  implicit val arbSeq: Arbitrary[Seq[Int]] = Arbitrary(Gen.nonEmptyContainerOf[Seq, Int](Arbitrary.arbitrary[Int]))
  ...
  implicit val arbStream: Arbitrary[Stream[Int]] = Arbitrary(
    Gen.nonEmptyContainerOf[Stream, Int](Arbitrary.arbitrary[Int])
  )
  ...
  implicit val arbVector: Arbitrary[Vector[Int]] = Arbitrary(
    Gen.nonEmptyContainerOf[Vector, Int](Arbitrary.arbitrary[Int])
  )
